...
import com.shaan.daffy.models.AnswerMember;
...
public class ReplyActivity extends AppCompatActivity {
    ...
    DatabaseReference votesref,Allquetions,reference1,reference2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference1 = database.getReference("All Users").child(uid);
