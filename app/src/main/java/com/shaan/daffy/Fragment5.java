...
public class Fragment5 extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        RectButton sendtochatactivity;

        sendtochatactivity = getActivity().findViewById(R.id.sendtochatactivity);
        sendtochatactivity.setOnClickListener(new View.OnClickListener() {
            @Override
